...
var _rnnoise_init = Module["_rnnoise_init"] = createExportWrapper("rnnoise_init", 2);

var _rnnoise_create = Module["_rnnoise_create"] = createExportWrapper("rnnoise_create", 1);

var _rnnoise_destroy = Module["_rnnoise_destroy"] = createExportWrapper("rnnoise_destroy", 1);

var _rnnoise_process_frame = Module["_rnnoise_process_frame"] = createExportWrapper("rnnoise_process_frame", 3);
...
(() => {
  // Create a small, never-async wrapper around createRNNWasmModuleSync which
  // checks for callers incorrectly using it with `new`.
  var real_createRNNWasmModuleSync = createRNNWasmModuleSync;
  createRNNWasmModuleSync = function(arg) {
    if (new.target) throw new Error("createRNNWasmModuleSync() should not be called with `new createRNNWasmModuleSync()`");
    return real_createRNNWasmModuleSync(arg);
  }
})();
